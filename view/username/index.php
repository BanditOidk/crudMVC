...
?>
<div class="mb-3">
    <a href="/proyecto/view/username/create.php" class="btn btn-primary">Agregar nuevo Registro</a>
</div>
<table class="table">
    <thead>
        <tr>
        ...
        <?php if($rows): ?>
            <?php foreach($rows as $row): ?>
                <tr>
                    <th><?= $row[0] ?></th>
                    <th><?= $row[1] ?></th>
                    <th><img src="data:image/jpg;base64, <?php echo base64_encode($row['2']); ?>" height="190" width="230" ></th>
                    <th>s/.<?= $row[3] ?></th>
                    <th>
