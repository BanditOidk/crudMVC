        ...
        <div class="container-fluid">
            ...
            <ul class="navbar-nav">
                ...
                <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="/proyecto/view/username/index.php">Registros</a></li>
                    <li><a class="dropdown-item" href="/proyecto/view/username/create.php">Agregar nuevos Registros</a></li>
                </ul>
                </li>
            </ul>
            </div>
